...
const DrawerSidebar: React.FC<DrawerSidebarProps> = ({ isOpen, onClose }) => (
  <div className={`fixed inset-y-0 left-0 transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} w-64 bg-gray-100 dark:bg-gray-800 overflow-auto ease-in-out transition-all duration-300 z-30 md:hidden`}>
    <div className="p-4">
      <button
